...
function ProfileEdit({ state, functions }) {
  ...
  const updateName = async () => {
    await fetch(process.env.REACT_APP_URL_DEV + "/users/profile", {
      method: "PUT",
      headers: {
  ...
  const updatePicture = async (e) => {
    ...
    try {
      const res = await axios.put(
        process.env.REACT_APP_URL_DEV + "/users/profile/picture",
        formData,
        {
          headers: {
  ...
  return (
    <div
      ...
      style={{ marginLeft: sideState === "profile" ? "" : "-100%" }}
    >
      ...
      <div className="EditPage">
            ...
            <div className="EditIcon">
              {EditName ? (
                <div style={{ display: "block ruby" }}>
                  <MdDone className="EditIcon" onClick={updateName} />
                </div>
              ) : (
                <MdEdit
                  className="EditIcon"
        ...
        <div className="NameInfo">
          <span>
            This is your Username. This Name is Visible to your WhatsApp
            Contacts.
          </span>
        </div>
        <div className="BioDiv">
          ...
          <div className="BioContent">
            ...
            <div className="EditIcon">
              {EditBio ? (
                <MdDone className="EditIcon" onClick={updateBio} />
              ) : (
                <MdEdit className="EditIcon" onClick={() => setEditBio(true)} />
              )}
            </div>
          </div>
        </div>
